...
Usage and design are documented below. See [SECURITY.md](SECURITY.md) for the
security model and private vulnerability reporting, and
[CONTRIBUTING.md](CONTRIBUTING.md) to build and contribute.
