...
// connecting process. The robust answer is kernel-asserted attribution (Tier 3:
// NETransparentProxyProvider on macOS, WFP on Windows) — see
// docs/attribution.md. Until then peer verification is a documented no-op here.
